...
def read(path):
    """
    <summary>
    The file's text with its line endings kept as they are.
    </summary>
...
def main(argv):
    """
    <summary>
    Run the get or set command.
    </summary>
    <param name="argv">The command line: get <addon.xml>, or set <addon.xml> <version>.</param>
    <returns>0 on success.</returns>
    <remarks>
    Anything else exits with the usage text; set refuses a version that is not major.minor.build or a file with no version on its root element.
    </remarks>
    """
